module dgt_apt_contract_v4::signal_v4 {
    ...
    public entry fun like_post(account: &signer, post_owner_addr: address, post_index: u64) acquires Signal {
        assert!(exists<Signal>(MODULE_ADDRESS), ERROR_NOT_INITIALIZED);
    ...
    public entry fun make_comment(account: &signer, post_owner_addr: address, post_index: u64, content: String) acquires Signal {
        assert!(exists<Signal>(MODULE_ADDRESS), ERROR_NOT_INITIALIZED);
    ...
    public entry fun like_comment(account: &signer, post_owner_addr: address, post_index: u64, comment_index: u64) acquires Signal {
        assert!(exists<Signal>(MODULE_ADDRESS), ERROR_NOT_INITIALIZED);
